...
agent = ClaudeAgent("claude-3-haiku-20240307", params.INITIAL_FISHING_MESSAGE) # claude-3-haiku-20240307 claude-3-7-sonnet-20250219
#agent = OpenAIAgent("gpt-3.5-turbo-0125", params.INITIAL_FISHING_MESSAGE) # gpt-3.5-turbo-0125 gpt-4o-mini gpt-o3-mini
